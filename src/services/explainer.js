...
export async function buildAiHtml(actorJsonText) {
  ...
  if (cfg.ok) {
    try {
      const prompt = `Summarize this Sakila actor for a business UI. Include their name and mention some of the films they appeared in if available. Provide 2-4 short sentences and avoid speculation.\n\n` +
